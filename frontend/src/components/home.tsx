            ...
            <section className="app_todo_card_grid_container">
              <div className="app_todo_card">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Zobrazit potvrzení o úspěšném odeslání</strong>{" "}
                    <br />→ jednoduchá děkovací stránka nebo message
                  </li>{" "}
                  <li>
                    <strong>Volitelně: Dockerizace</strong> <br />→ Setup
                    docker.
                  </li>
                </ul>
              </div>
              <div className="app_todo_card">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Zpracovat příchozí JSON data</strong> <br />→
                    přijmout data z formuláře ve správném formátu
                  </li>
                  <li>
